export const fr = {
  ...
  pattern: {
    ...
    trafficTimelineDragAria: "Redimensionner la timeline trafic",
    trafficTimelineDurationDay: "{count} jour",
    trafficTimelineDurationDays: "{count} jours",
    trafficTimelineDurationHour: "{count} h",
    trafficTimelineDurationHours: "{count} h",
    trafficTimelineDurationMinute: "{count} min",
    trafficTimelineDurationMinutes: "{count} min",
    trafficTimelineDurationMonth: "{count} mois",
    trafficTimelineDurationMonths: "{count} mois",
    trafficTimelineNext: "Suivant",
    trafficTimelinePrevious: "Precedent",
    trafficTimelineStationsOne: "{count} station",
    trafficTimelineStationsOther: "{count} stations",
    trafficTimelineTitle: "Interruptions a venir",
    trafficTimelineToday: "Aujourd'hui",
