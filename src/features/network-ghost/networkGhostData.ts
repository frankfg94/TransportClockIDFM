...
export function getNetworkGhostStrokeWidth(
  transfer: TransferLineOption,
): number {
  switch (getNetworkGhostModeKey(transfer)) {
    case "bus":
    case "noctilien":
      return 4;
    case "metro":
...
export function createNetworkGhostLine(
  ...
  return {
    ...
    family: transfer.family,
    ref: transfer.ref,
    color: normalizeColor(presentation.color, "#475569"),
    textColor: normalizeColor(presentation.textColor, "#ffffff"),
